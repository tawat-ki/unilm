...
python run_seq2seq.py \
    ...
    --train_folder /home/tawat-ki/project/datasets/ReadingBank/test \
    ...
    --label_smoothing 0.1 \
    --save_steps 5000 \
    --cached_train_features_file /home/tawat-ki/project/datasets/ReadingBank/test/feature_train.pt
